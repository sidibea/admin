 ...
 */
class Outcome extends \NB\MainBundle\Entity\Outcome implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NB\\MainBundle\\Entity\\Outcome' . "\0" . 'id', '' . "\0" . 'NB\\MainBundle\\Entity\\Outcome' . "\0" . 'montant', '' . "\0" . 'NB\\MainBundle\\Entity\\Outcome' . "\0" . 'seatseller', '' . "\0" . 'NB\\MainBundle\\Entity\\Outcome' . "\0" . 'reservation', '' . "\0" . 'NB\\MainBundle\\Entity\\Outcome' . "\0" . 'datePaiement', '' . "\0" . 'NB\\MainBundle\\Entity\\Outcome' . "\0" . 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Outcome $proxy) {
